package com.gmail.yu0310.applicationcalc;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 数字ボタンを取得
        buttonList.add((Button) findViewById(R.id.b0));//0
        buttonList.add((Button) findViewById(R.id.b1));//1
        buttonList.add((Button) findViewById(R.id.b2));//2
        buttonList.add((Button) findViewById(R.id.b3));//3
        buttonList.add((Button) findViewById(R.id.b4));//4
        buttonList.add((Button) findViewById(R.id.b5));//5
        buttonList.add((Button) findViewById(R.id.b6));//6
        buttonList.add((Button) findViewById(R.id.b7));//7
        buttonList.add((Button) findViewById(R.id.b8));//8
        buttonList.add((Button) findViewById(R.id.b9));//9
        ...
        // その他ボタンを取得
        buttonList.add((Button) findViewById(R.id.bc));//一文字クリア
        buttonList.add((Button) findViewById(R.id.bac));//オールクリア
